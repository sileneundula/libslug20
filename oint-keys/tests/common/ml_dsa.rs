...
#[test]
fn _0x00_MLDSA3_generation() {
    let keypair = OpenInternetKeypair::generate(Algorithms::MLDSA3).unwrap();
}

#[test]
fn _0x02_MLDSA3_generation_and_signing_no_context() {
    let keypair = OpenInternetKeypair::generate(Algorithms::MLDSA3).unwrap();
...
#[test]
fn _0x01_MLDSA3_generation_and_signing_with_context() {
    let keypair = OpenInternetKeypair::generate(Algorithms::MLDSA3).unwrap();
...
#[test]
fn _0x04_MLDSA3_generation_and_signing_no_context_verifying() {
    let keypair = OpenInternetKeypair::generate(Algorithms::MLDSA3).unwrap();
...
#[test]
fn _0x03_MLDSA3_generation_and_signing_with_context_verifying() {
    let keypair = OpenInternetKeypair::generate(Algorithms::MLDSA3).unwrap();
...
#[test]
#[should_panic]
fn _0x06_MLDSA3_wrong_message_with_context() {
    let keypair = OpenInternetKeypair::generate(Algorithms::MLDSA3).unwrap();
...
#[test]
#[should_panic]
fn _0x07_MLDSA3_wrong_message_with_wrong_context() {
    let keypair = OpenInternetKeypair::generate(Algorithms::MLDSA3).unwrap();
...
#[test]
#[should_panic]
fn _0x05_MLDSA3_wrong_message_with_no_context() {
    let keypair = OpenInternetKeypair::generate(Algorithms::MLDSA3).unwrap();
...
#[test]
#[should_panic]
fn _0x09_MLDSA3_right_message_with_no_context_after_signing_with_context() {
    let keypair = OpenInternetKeypair::generate(Algorithms::MLDSA3).unwrap();
...
#[test]
#[should_panic]
fn _0x0A_MLDSA3_right_message_with_no_context_after_signing_with_no_context_and_providing_context() {
    let keypair = OpenInternetKeypair::generate(Algorithms::MLDSA3).unwrap();
...
#[test]
#[should_panic]
fn _0x0B_MLDSA3_wrong_signature() {
    let keypair = OpenInternetKeypair::generate(Algorithms::MLDSA3).unwrap();
