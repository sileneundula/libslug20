...
#[test]
fn _0x00_ECDSA_generation() {
    let keypair = OpenInternetKeypair::generate(Algorithms::ECDSA).unwrap();
}

#[test]
fn _0x02_ECDSA_generation_and_signing_no_context() {
    let keypair = OpenInternetKeypair::generate(Algorithms::ECDSA).unwrap();
...
#[test]
fn _0x01_ECDSA_generation_and_signing_with_context() {
    let keypair = OpenInternetKeypair::generate(Algorithms::ECDSA).unwrap();
...
#[test]
fn _0x04_ECDSA_generation_and_signing_no_context_verifying() {
    let keypair = OpenInternetKeypair::generate(Algorithms::ECDSA).unwrap();
...
#[test]
fn _0x03_ECDSA_generation_and_signing_with_context_verifying() {
    let keypair = OpenInternetKeypair::generate(Algorithms::ECDSA).unwrap();
...
#[test]
#[should_panic]
fn _0x06_ECDSA_wrong_message_with_context() {
    let keypair = OpenInternetKeypair::generate(Algorithms::ECDSA).unwrap();
...
#[test]
#[should_panic]
fn _0x07_ECDSA_wrong_message_with_wrong_context() {
    let keypair = OpenInternetKeypair::generate(Algorithms::ECDSA).unwrap();
...
#[test]
#[should_panic]
fn _0x05_ECDSA_wrong_message_with_no_context() {
    let keypair = OpenInternetKeypair::generate(Algorithms::ECDSA).unwrap();
...
#[test]
#[should_panic]
fn _0x09_ECDSA_right_message_with_no_context_after_signing_with_context() {
    let keypair = OpenInternetKeypair::generate(Algorithms::ECDSA).unwrap();
...
#[test]
#[should_panic]
fn _0x0A_ECDSA_right_message_with_no_context_after_signing_with_no_context_and_providing_context() {
    let keypair = OpenInternetKeypair::generate(Algorithms::ECDSA).unwrap();
...
#[test]
#[should_panic]
fn _0x0B_ECDSA_wrong_signature() {
    let keypair = OpenInternetKeypair::generate(Algorithms::ECDSA).unwrap();
