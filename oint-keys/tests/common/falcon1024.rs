...
#[test]
fn _0x00_Falcon1024_generation() {
    let keypair = OpenInternetKeypair::generate(Algorithms::Falcon1024).unwrap();
}

#[test]
fn _0x02_Falcon1024_generation_and_signing_no_context() {
    let keypair = OpenInternetKeypair::generate(Algorithms::Falcon1024).unwrap();
...
#[test]
fn _0x01_Falcon1024_generation_and_signing_with_context() {
    let keypair = OpenInternetKeypair::generate(Algorithms::Falcon1024).unwrap();
...
#[test]
fn _0x04_Falcon1024_generation_and_signing_no_context_verifying() {
    let keypair = OpenInternetKeypair::generate(Algorithms::Falcon1024).unwrap();
...
#[test]
fn _0x03_Falcon1024_generation_and_signing_with_context_verifying() {
    let keypair = OpenInternetKeypair::generate(Algorithms::Falcon1024).unwrap();
...
#[test]
fn _0x08_Falcon1024_wrong_context() {
    let keypair = OpenInternetKeypair::generate(Algorithms::Falcon1024).unwrap();
...
#[test]
#[should_panic]
fn _0x06_Falcon1024_wrong_message_with_context() {
    let keypair = OpenInternetKeypair::generate(Algorithms::Falcon1024).unwrap();
...
#[test]
#[should_panic]
fn _0x07_Falcon1024_wrong_message_with_wrong_context() {
    let keypair = OpenInternetKeypair::generate(Algorithms::Falcon1024).unwrap();
...
#[test]
#[should_panic]
fn _0x05_Falcon1024_wrong_message_with_no_context() {
    let keypair = OpenInternetKeypair::generate(Algorithms::Falcon1024).unwrap();
...
#[test]
#[should_panic]
fn _0x09_Falcon1024_right_message_with_no_context_after_signing_with_context() {
    let keypair = OpenInternetKeypair::generate(Algorithms::Falcon1024).unwrap();
...
#[test]
#[should_panic]
fn _0x0A_Falcon1024_right_message_with_no_context_after_signing_with_no_context_and_providing_context() {
    let keypair = OpenInternetKeypair::generate(Algorithms::Falcon1024).unwrap();
...
#[test]
#[should_panic]
fn _0x0B_Falcon1024_wrong_signature() {
    let keypair = OpenInternetKeypair::generate(Algorithms::Falcon1024).unwrap();
